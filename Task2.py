...
shift_label.grid(row=7, column=0, padx=5, pady=5)

shift_entry = tk.Entry(window)
shift_entry.grid(row=7, column=1, padx=5, pady=5)

shift_button = tk.Button(window, text="Shift", command=lambda: shift_signal(file_list[0], shift_entry.get()))
shift_button.grid(row=7, column=2, padx=5, pady=5)
